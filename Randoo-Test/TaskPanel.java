...
//    JButton completeTaskB = new JButton();
    ...
    void jbInit() throws Exception {
        ...
        newTaskB.setToolTipText(Local.getString("Create new tour"));
...
*/
        ...
        editTaskB.setToolTipText(Local.getString("Edit tour"));
   ...
   //     editTaskB.setEnabled(true);
        ...
        removeTaskB.setToolTipText(Local.getString("Remove tour"));
...
//			new ImageIcon(net.sf.memoranda.ui.AppFrame.class.getResource("/ui/icons/todo_remove.png")));
        ...
        emptyList.setMaximumSize(new Dimension(32767, 32767));
        emptyList.setFixedCellHeight(24);
        ppEditTask.setFont(new java.awt.Font("Dialog", 1, 11));
    ppEditTask.setText(Local.getString("Edit tour")+"...");
    ...
    */
    ...
    scrollPane.getViewport().add(emptyList, null);
...
//        tasksToolBar.add(completeTaskB, null);
        ...
        emptyList.addMouseListener(ppListener);
